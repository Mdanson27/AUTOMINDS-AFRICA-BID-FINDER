...
const catalog = ["eGP Uganda", "GPP / PPDA", "Daily Monitor", "New Vision", "URA", "KCCA", "NITA-U", "UN / Development Partners"];
const scopes = [
  { id: "all", label: "Everywhere", icon: Globe2, patterns: [] as string[] },
  { id: "government", label: "Government", icon: Landmark, patterns: ["egp", "ppda", "gpp", "ura", "kcca", "nita", "unra", "ucc", "nwsc", "ministry"] },
  { id: "newspapers", label: "Newspapers", icon: Newspaper, patterns: ["monitor", "new vision", "newspaper"] },
  { id: "development", label: "NGO & Development", icon: UsersRound, patterns: ["un ", "ungm", "giz", "enabel", "usaid", "ngo", "development"] },
